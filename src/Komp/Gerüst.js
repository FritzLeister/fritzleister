...
export default function Gerüst({
    ...
    const wallOpeningVolumes = useMemo(() => getWallOpeningVolumes({
        objs,
        x,
        z,
        ...
        bodenLänge,
        bodenBreite,
    }), [objs, x, z, koordinate, gebäudeHöhe, sockelHöhe, bodenLänge, bodenBreite])

    const wallOpeningSightVolumes = useMemo(() => getWallOpeningSightVolumes({
        wallOpeningVolumes,
        x,
        z,
        bodenLänge,
        bodenBreite,
    }), [wallOpeningVolumes, x, z, bodenLänge, bodenBreite])
    return(
        <>
